...
\insertimagerightline[\label{figure:patterns}]{img/tabla_2022.png}{0.5}{6}{Frecuencias por caso.}

\lipsum[1]

\begin{images}[\label{figure:glove}]{Visualización de textos más frecuentes del dataset para el caso Adela}
...
\begin{images}[\label{figure:glove}]{Visualización de largos de texto para caso Adela, con y sin \textit{stop-words}.}
...
\insertimagerightline[\label{figure:patterns}]{img/adela/freq_adela.png}{0.55}{17}{Frecuencias de posturas por etapa en caso Adela}

\newp \lipsum[3]

\subsubsection{Condicionamiento a selección de postura y etapa de actividad}

\insertimage[\label{img:modelo3}]{img/adela/boxplot_largo_sel_adela}{scale=0.5}{Boxplots de largos de texto para cada elección de postura.}
